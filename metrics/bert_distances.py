...
class FBD:
    def __init__(self, references, model_name, bert_model_dir):
        ...
        self.references_mu, self.references_sigma = self._calculate_statistics(references)
    ...
    def get_score(self, sentences):
        ...
        return calculate_frechet_distance(self.references_mu, self.references_sigma, mu, sigma)
...
class FBD_EMBD:
    def __init__(self, references, model_name, bert_model_dir):
        ...
        self.references_mu, self.references_sigma = self._calculate_statistics(self.reference_features)
    ...
    def get_score(self, sentences):
        ...
        M = ot.dist(self.reference_features, features, metric="sqeuclidean")
        res["EMBD"] = ot.emd2(a=[], b=[], M=M)

        mu, sigma = self._calculate_statistics(features)
        res["FBD"] = calculate_frechet_distance(self.references_mu, self.references_sigma, mu, sigma)
